...
export const am: LocaleOverlay = {
  ...
  voice: {
    hold: "ለመናገር ተጭነው ይያዙ",
    holding: "እያዳመጥኩ ነው፤ ለመላክ ይልቀቁ",
    thinking: "ምን እንደምል እያሰብኩ ነው",
    speaking: "እየተናገርኩ ነው",
    stop: "አቁም",
    activeVoice: "የድምጽ ሁነታ። ጮክ ብዬ እመልስልዎታለሁ።",
    activeLive: "የቀጥታ ሁነታ። አዳምጬ አግዝዎታለሁ እንጂ አልመልስም።",
    keepListening: "ከመለስኩ በኋላ ማይክሮፎኑ ክፍት ይቆይ",
    keepListeningHelp: "ስልኩን እንደገና ሳያነሱ እንዲቀጥሉ ለጥቂት ሰከንዶች ክፍት ሆኖ ይቆያል።",
    childCanHear: "ልጅዎ ይህን ይሰማል",
    childCanHearHelp:
      "ሲበራ፣ መልሱን ጮክ ብዬ አልናገርም፣ የት እንደተሳሳተ አልጠቅስም፣ ስሙንም አልጠራም። ሙሉው ቅጂ እርስዎ ብቻ በሚያነቡት ስክሪንዎ ላይ ይቀራል።",
    childCanHearOffHelp:
      "ሲጠፋ፣ ጮክ ብዬ ይበልጥ ግልጽ መሆን እችላለሁ። መልሱ ግን አሁንም የሚገኘው ተጭነው በመያዝ ብቻ ነው።",
    onScreen: "በስክሪንዎ ላይ ነው፤ ተጭነው ከሚይዙት ጀርባ።",
    unconfigured: "ይህ ተከላ እስካሁን መናገር አይችልም። ሌላው ሁሉ ይሠራል።",
    limit: "የዛሬውን የድምጽ ጣሪያ ደርሰናል። መጻፍ አሁንም ይሠራል።",
    nothingHeard: "አልሰማሁትም። ሲናገሩ ቁልፉን ተጭነው ይያዙ።",
    tooLong: "ረዥም ነበር። በአንድ ወይም በሁለት ዓረፍተ ነገር ይሞክሩ።",
    failed: "አልደረሰም። እንደገና ይናገሩ።",
    micDenied: "አሳሽዎ ማይክሮፎኑን አልሰጠንም። የድምጽ ሁነታ ያስፈልገዋል።",
    unsupported: "ይህ አሳሽ ድምጽ መቅዳት አይችልም፤ ስለዚህ የድምጽ ሁነታ ጠፍቷል። መጻፍ ይሠራል።",
  },
